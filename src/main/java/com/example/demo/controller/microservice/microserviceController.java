...
@RestController
@RequestMapping(path = "/public/jms",produces = "application/json")
public class microserviceController {
	...
	@Autowired
	public microserviceController(JmsTemplateSenderService jmsTemplateSenderService,JmsTemplateReceiver jmsTemplateReceiver,RabbitTemplateSenderService rabbitTemplateSenderService) {
